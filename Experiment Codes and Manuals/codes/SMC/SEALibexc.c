...
double SMCCompute(double QdRef, double QdRefDot, double QdRefDotDot, double C, double P){
  ...
  return  P*(SMC.sigma/(fabs(SMC.sigma) + eps)) + SEAnominal.Jmn*SEAnominal.Nm*(QdRefDotDot + W1*SEA.torsion + W2* SEA.motorVel + (SEAnominal.Bln/SEAnominal.Jln)*SEA.torsionVel + C*(SMC.errorDot));
}
